...
// node_modules/web3-eth-accounts/node_modules/@ethereumjs/rlp/dist/index.js
var require_dist = __commonJS({
  "node_modules/web3-eth-accounts/node_modules/@ethereumjs/rlp/dist/index.js"(exports) {
    "use strict";
...
var padLeft = (value, characterAmount, sign5 = "0") => {
  if (typeof value === "string" && !isHexStrict(value)) {
    return value.padStart(characterAmount, sign5);
  }
  ...
  return `${prefix}${hexValue.padStart(characterAmount, sign5)}`;
};
...
var padLeft2 = (value, characterAmount, sign5 = "0") => {
  if (typeof value === "string") {
    if (!isHexStrict(value)) {
      return value.padStart(characterAmount, sign5);
    }
    return utils_exports.padLeft(value, characterAmount, sign5);
  }
  validator.validate(["int"], [value]);
  return utils_exports.padLeft(value, characterAmount, sign5);
};
var padRight = (value, characterAmount, sign5 = "0") => {
  if (typeof value === "string" && !isHexStrict(value)) {
    return value.padEnd(characterAmount, sign5);
  }
  validator.validate(["int"], [value]);
  const hexString = typeof value === "string" && isHexStrict(value) ? value : numberToHex2(value);
  const prefixLength = hexString.startsWith("-") ? 3 : 2;
  return hexString.padEnd(characterAmount + prefixLength, sign5);
};
...
// node_modules/web3-providers-ws/node_modules/isomorphic-ws/browser.js
var ws = null;
...
function parseAbiParameter(param, options) {
  ...
  if (match.modifier) {
    if (!((_b = (_a4 = options == null ? void 0 : options.modifiers) == null ? void 0 : _a4.has) == null ? void 0 : _b.call(_a4, match.modifier)))
      throw new BaseError("Invalid ABI parameter.", {
        details: param,
        metaMessages: [
...
export {
  ...
  esm_exports12,
  decodeEventABI,
  getProtocolVersion2 as getProtocolVersion,
  isSyncing,
  getCoinbase2 as getCoinbase,
  isMining,
  getHashRate2 as getHashRate,
  ...
  getUncle,
  getTransaction,
  getPendingTransactions2 as getPendingTransactions,
  ...
  sign4 as sign2,
  signTransaction4 as signTransaction2,
  call2 as call,
  ...
  createAccessList2 as createAccessList,
...
@noble/curves/esm/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-WNIHVIVP.js.map
